  ...
  return (
    <div className="flex flex-1 flex-col">
      <PageHero
        ...
        description="Preencha o formulário e confirmaremos sua reserva em até 24 horas."
      />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 card overflow-hidden p-0">
              <div className="border-b border-zinc-100 bg-gradient-to-r from-orange-50/80 to-white px-6 py-5 md:px-8">
                <h2 className="heading-md">Dados da reserva</h2>
            ...
            <aside className="space-y-4" aria-label="Informações adicionais">
              ...
              <div className="card p-5">
                <h3 className="text-sm font-semibold text-zinc-950 mb-3">Política de reservas</h3>
                <ul className="space-y-1.5 text-sm text-zinc-500">
                  <li>Confirmação em até 24 horas</li>
                  <li>Cancelamento com 4h de antecedência</li>
                  <li>Tolerância de 15 minutos</li>
                </ul>
                <Link href="/termos" className="inline-block mt-3 text-xs font-medium text-zinc-950 hover:underline">
